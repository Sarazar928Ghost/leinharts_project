...
class Round:
    def __init__(self, name: str, pairs: list, matches: list[Match] = None) -> None:
        self.name = name
    ...
    def generate_matches(self, pairs: list) -> list[Match]:
        return [Match(players) for players in pairs]
